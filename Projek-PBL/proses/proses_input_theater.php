...
if (!empty($_POST['input_theater_validate'])) {
    ...
    if (mysqli_num_rows($select) > 0) {
        ...
        $query = mysqli_query($conn, "INSERT INTO tb_theaters (kota,nama_theater,alamat,nohp,harga_weekend,harga_weekday) VALUES ('$kota','$nama_theater','$alamat','$nohp','$harga_weekend','$harga_weekday')");
        if ($query) {
