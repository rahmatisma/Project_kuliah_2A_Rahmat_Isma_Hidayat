...
if (!empty($_POST['input_menu_validate'])) {
    ...
    if($statusUpload == 0) {
        ...
        if (mysqli_num_rows($select) > 0) {
            ...
            $query = mysqli_query($conn, "UPDATE tb_menu SET foto_menu ='".$foto_lama."', nama_theater='$theater', nama_menu='$nama_menu', keterangan='$keterangan', harga='$harga', kategori='$kat_menu', stok='$stok' WHERE id_menu = '$id_menu'");
            if ($query) {
